...
The official documentation for [Start9](https://start9.com) products — covering StartOS and StartTunnel.
...
| Product | URL | Content |
|---------|-----|---------|
| [StartOS](startos/) | [docs.start9.com/startos](https://docs.start9.com/startos/) | Installation, user manual, architecture, FAQ, service packaging, firmware |
...
1. Builds both books into a single `docs/` output directory
