...
- **Data Usage** — A chart showing historical upload and download over time. Use the dropdown to select a time period: Week (7 days), Month (30 days), or 3 Months (90 days). Usage history survives firmware updates.
